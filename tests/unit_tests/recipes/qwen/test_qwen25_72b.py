...
from megatron.bridge.models.qwen import Qwen2p5ModelProvider72B
...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, Qwen2p5ModelProvider72B)
...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, Qwen2p5ModelProvider72B)
